...
- (void)performLayout {
    ...
    if ([self.navigationController.viewControllers objectAtIndex:0] == self) {
        ...
        if ([UIBarButtonItem respondsToSelector:@selector(appearance)]) {
            ...
            [_doneButton setTitleTextAttributes:@{ NSFontAttributeName: [UIFont fontWithName:@"AmericanTypewriter" size:15]}
...
- (void)hideControls { [self setControlsHidden:YES animated:NO permanent:NO]; }
- (void)toggleControls {
